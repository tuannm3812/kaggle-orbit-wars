...
on account `tuannm3812` and has dropped to `451.2` after early public games,
...
failed challenger until replays explain the failure. v5 also underperformed v3
after moving down to `451.2`; its 30/30 random smoke result did not translate to
public strength.

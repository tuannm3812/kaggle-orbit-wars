...
As of 2026-06-04, account `tuannm3823` has four Orbit Wars submissions.
...
| --- | --- | --- | --- | --- |
| `submission.tar.gz` | `2026-06-04 00:22:31.283000` | `roi_reserve_v3: tempo reserve, local expansion, incoming-threat hold` | `SubmissionStatus.COMPLETE` | `547.5` |
| `submission.tar.gz` | `2026-06-03 22:25:31` | `roi_reserve_v2: consolidated submission notebook, 29/30 smoke` | `SubmissionStatus.COMPLETE` | `429.3` |
...
and losses plus replay evidence is the meaningful signal. The first v3 movement
was downward from `600.0` to `547.5`, which means the early public games exposed
losses despite the smoke benchmark passing.
